...
hist(household_power_consumption_2days$Global_active_power, main = "Global Active Power", 
     xlab = "Global Active Power (kilowatts)", ylab = "Frequency", col = "Red")

## Save the diagram as png file.
dev.copy(png, file="exploratory_data_analysis/plot1.png", height = 480, width = 480)
dev.off()
